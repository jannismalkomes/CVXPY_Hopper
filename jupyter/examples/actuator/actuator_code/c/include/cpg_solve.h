...
extern void cpg_update_lamb_sm(cpg_float val);
extern void cpg_update_kappa(cpg_int idx, cpg_float val);
extern void cpg_update_A(cpg_int idx, cpg_float val);
extern void cpg_update_w(cpg_int idx, cpg_float val);
extern void cpg_update_u_min(cpg_int idx, cpg_float val);
extern void cpg_update_u_max(cpg_int idx, cpg_float val);
extern void cpg_update_u_prev(cpg_int idx, cpg_float val);
