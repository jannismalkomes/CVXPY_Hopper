...
```bash
cd /workspaces/CVXPY_Hopper/src/Trajectory_Generator_5/code_export && ./c/build/cpg_example --r_initial 0 0 10 --v_initial 0 0 0 --r_target 0 0 0 --v_target 0 0 0 --tf 12 --v_max 10 --g_max 10 --lambda_path 0.001 --lambda_smooth 0.0001 --feastol 1e-4 --abstol 1e-4 --reltol 1e-4 > out.txt
```
