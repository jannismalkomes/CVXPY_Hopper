...
if __name__ == "__main__":
    ...
    try:
        ...
        if results['success']:
            ...
            if generator.data_exporter.export_trajectory_data(generator.last_solution, generator.N, "gfold_trajectory.csv"):
            ...
            if generator.data_exporter.export_comprehensive_data(
                    generator.last_solution, generator.N,
                    generator._problem3_stats if hasattr(
                        generator, '_problem3_stats') else None,
                    generator._problem4_stats if hasattr(
                        generator, '_problem4_stats') else None,
                    "gfold_comprehensive"):
