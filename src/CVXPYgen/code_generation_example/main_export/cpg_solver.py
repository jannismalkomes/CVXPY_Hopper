...
from main_export import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.var_dict['x'].save_value(np.array(res.cpg_prim.x).reshape((2,), order='F'))
    prob.constraints[0].save_dual_value(np.array(res.cpg_dual.d0).reshape((2,), order='F'))
